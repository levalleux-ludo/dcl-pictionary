...
class Web3Provider {
  ...
  public getSignedContract(address: string, abi: ContractInterface) {
    return new ethers.Contract(address, abi, this._wallet);
  }

}

export const web3Provider = new Web3Provider(WEB3_NETWORK);